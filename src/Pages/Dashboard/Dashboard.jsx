    ...
    return (
        <main className="w-11/12 my-10 mx-auto">
            ...
            <section className="flex items-center justify-center gap-6 w-full">
                ...
                <div className="p-4 bg-white rounded-xl shadow-md/30 w-full">
            ...
            <h5 className="text-xl font-semibold mb-6 mt-10">Latest Transaction</h5>
            {
                userInfo?.role === "admin"
                &&
                <section className="w-full rounded-2xl shadow-md/30 p-8 space-y-2 bg-white">
                            <div className="grid grid-cols-3 items-center-safe justify-items-center-safe px-6 py-2 gap-2 font-bold">
                                <p>Sender</p>
                                <p>Transaction Id</p>
                                <p>Amount</p>
                            </div>
                    {
                        transactions.map(e => (
                            <div key={e._id} className="grid grid-cols-3 items-center-safe text-sm justify-items-center-safe font-medium gap-2 px-6 py-2 rounded-lg trns hover:bg-gray-100">
                                <p>{e.paidBy}</p>
                                <p className="text-xs">{e.transactionId}</p>
                                <p>{e.amount}</p>
                            </div>
                        ))
                    }
